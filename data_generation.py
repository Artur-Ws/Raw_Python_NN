...
def spiral(n_points, n_clases, param1=4, param2=4, noise=0.1, color=True):
    """
    ...
    :param color: if true colorize data by classes
    :return:
    """
    ...
    for i in range(n_clases):
        ...
        y[ix] = i
    plt.scatter(x[:, 0], x[:, 1], c=y if color == True else None)
    plt.show()